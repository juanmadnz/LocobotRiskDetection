...
#include "audio_common_msgs/msg/detail/audio_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const audio_common_msgs::msg::AudioData & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: float32_data
  {
    cdr << ros_message.float32_data;
  }
  // Member: int32_data
  {
    cdr << ros_message.int32_data;
  }
  // Member: int16_data
  {
    cdr << ros_message.int16_data;
  }
  // Member: int8_data
  {
    cdr << ros_message.int8_data;
  }
  // Member: uint8_data
  {
    cdr << ros_message.uint8_data;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  audio_common_msgs::msg::AudioData & ros_message)
{
  // Member: float32_data
  {
    cdr >> ros_message.float32_data;
  ...
  size_t current_alignment)
{
  ...
  // Member: float32_data
  {
    ...
    size_t item_size = sizeof(ros_message.float32_data[0]);
  ...
  // Member: int32_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.int32_data[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: int16_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.int16_data[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: int8_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.int8_data[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: uint8_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.uint8_data[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = audio_common_msgs::msg::AudioData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const audio_common_msgs::msg::AudioData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<audio_common_msgs::msg::AudioData *>(
    untyped_ros_message);
...
{
  return &audio_common_msgs::msg::typesupport_fastrtps_cpp::_AudioData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, audio_common_msgs, msg, AudioData)() {
  return &audio_common_msgs::msg::typesupport_fastrtps_cpp::_AudioData__handle;
}
