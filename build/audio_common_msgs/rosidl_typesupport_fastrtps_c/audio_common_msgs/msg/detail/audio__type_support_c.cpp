...
#include "audio_common_msgs/msg/detail/audio__rosidl_typesupport_fastrtps_c.h"
...
#include "audio_common_msgs/msg/detail/audio_data__functions.h"  // audio_data
#include "audio_common_msgs/msg/detail/audio_info__functions.h"  // info
...
using _Audio__ros_msg_type = audio_common_msgs__msg__Audio;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: audio_data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, audio_common_msgs, msg, AudioData
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->audio_data, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, audio_common_msgs, msg, AudioInfo
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_audio_common_msgs__msg__AudioInfo(
...
static uint32_t _Audio__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_audio_common_msgs__msg__Audio(
  ...
  size_t current_alignment)
{
  ...
  // member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_audio_common_msgs__msg__AudioInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = audio_common_msgs__msg__Audio;
    is_plain =
      (
...
static size_t _Audio__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_audio_common_msgs__msg__Audio(
