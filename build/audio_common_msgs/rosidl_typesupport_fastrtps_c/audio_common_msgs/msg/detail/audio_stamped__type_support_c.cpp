...
#include "audio_common_msgs/msg/detail/audio_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "audio_common_msgs/msg/detail/audio__functions.h"  // audio
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_audio_common_msgs__msg__Audio(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_audio_common_msgs__msg__Audio(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_common_msgs, msg, Audio)();
...
using _AudioStamped__ros_msg_type = audio_common_msgs__msg__AudioStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: audio
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, audio_common_msgs, msg, Audio
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _AudioStamped__ros_msg_type * ros_message = static_cast<_AudioStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_audio_common_msgs__msg__AudioStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AudioStamped__ros_msg_type * ros_message = static_cast<const _AudioStamped__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_audio_common_msgs__msg__Audio(
...
static uint32_t _AudioStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_audio_common_msgs__msg__AudioStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_audio_common_msgs
size_t max_serialized_size_audio_common_msgs__msg__AudioStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: audio
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_audio_common_msgs__msg__Audio(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = audio_common_msgs__msg__AudioStamped;
    is_plain =
      (
...
static size_t _AudioStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_audio_common_msgs__msg__AudioStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_common_msgs, msg, AudioStamped)() {
